...
# 0. Project setup
# we establish folders to read/write data
data_dir = "data"
results_dir = "results"
...
# find all biological spreadsheet tables in the bio folder
...
# save the biological summary table to a csv file
if bio_results:
...
if os.path.exists(glottolog_path):
    ...
    for feat_path in feat_data_paths:
        ...
        # line up the feature text rows with our map coordinate master file
        ...
        k_spatial, k_structural = calculate_densities(
            ...
            id_col='glottocode',
            tree=tree_path,
            tree_type='adaptive',  # uses percentages to handle varying tree lengths safely
            ...
            structural_depth_threshold=15, # sets the threshold level for historical branch similarity
    ...
    # save the linguistic findings to a summary csv file
    if ling_results:
...
# save the cultural metrics to a summary csv file
if etc_results:
